...
import { featuresList, technicalInfo } from '@/lib/fusionFiber.utils';

export default function FusionFiberPage() {
  const service = getServiceById('fusion-fiber');
  const images = getServiceImages('fusion-fiber');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-white">
      ...
      <ServiceInfo
        ...
        subtitle="Utilizamos equipos de fusión de última generación y herramientas especializadas para garantizar empalmes de alta calidad con pérdidas mínimas."
      ...
      <ServiceFeatures
        ...
        subtitle="Ofrecemos servicios completos de fusión de fibra óptica, desde empalmes básicos hasta certificación de enlaces complejos."
